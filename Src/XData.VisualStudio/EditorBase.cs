...
namespace XData.VisualStudio.Editors {
    internal abstract class LanguageClassifierBase : IClassifier {
        ...
        private static readonly HashSet<string> _csKeywordSet = null;//CSTokens.KeywordSet;
    ...
    internal abstract class LanguageErrorTaggerProviderBase : ITaggerProvider {
        ...
        private sealed class ProjectData {
            ...
            internal Dictionary<string, LanguageErrorTagger> Taggers {
                get {
                    return _taggers ?? (_taggers = new Dictionary<string, LanguageErrorTagger>());
                }
            }
        }
                ...
                if (proj.Kind == _prjKindCSharpProject) {
                    ...
                    lock (_locker) {
                        if (!_projectDataSet.ContainsKey(projPath)) {
                            ...
                            _projectDataSet.Add(projPath, new ProjectData(fileWatcher, _errorStoreLoader(Path.Combine(projPath, "obj", _errorStoreFileName))));
